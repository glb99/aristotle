...
Split out of :mod:`aristotle.agent.context.assembly` because the choice has more than
...
Scope is not visible here. :func:`~aristotle.agent.context.assembly.assemble_context`
...
from aristotle.agent.session.store import MemoryEntry
