...
called now" — that is :mod:`aristotle.agent.tools.approval` — and it cannot call
anything itself — that is :mod:`aristotle.agent.tools.execution`. Describing a
...
class ToolRegistry:
    ...
    def register(self, tool: ToolDefinition) -> None:
        ...
        (:mod:`aristotle.agent.interfaces.cli`), and worth revisiting if it does not.
        """
