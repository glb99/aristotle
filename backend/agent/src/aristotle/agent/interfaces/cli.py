...
Not built:
    ...
    :mod:`aristotle.agent.session.store`.
...
from aristotle.agent.tools.approval import cli_approve
...
def build_tool_registry(session_store: SessionRepository, session_id: str) -> ToolRegistry:
    ...
    ``add_note`` is no longer registered. :mod:`aristotle.agent.tools.notes` is kept as
    ...
    surface. The precondition is :func:`~aristotle.agent.tools.approval.cli_approve`,
