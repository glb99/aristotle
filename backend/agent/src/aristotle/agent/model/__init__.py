...
Splitting them shows up concretely in :mod:`aristotle.agent.model.errors`, where the
...
:mod:`aristotle.agent.tools`, which is what makes that a structural guarantee rather
than a rule someone has to remember.

Start at :mod:`aristotle.agent.model.protocol` — it defines the contract both clients
