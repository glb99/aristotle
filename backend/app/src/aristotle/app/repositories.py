"""Persistence for the entities in :mod:`aristotle.app.models`.
...
from aristotle.app.models import User, UserCreate, UserId
...
class UserRepository:
    ...
    :mod:`aristotle.app.core.protocols` structurally — it inherits nothing and
