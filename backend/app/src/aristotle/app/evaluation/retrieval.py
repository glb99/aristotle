...
settles nothing. :func:`~aristotle.app.graph.service.claims_for` takes ``as_of``
...
to get one. A model judging is refused by :mod:`aristotle.app.evaluation.checks`
...
Not built:
    ...
    :mod:`aristotle.app.evaluation.checks` scoring hit rates across the labelled
...
from aristotle.app.sessions.models import ChatTranscriptItem
