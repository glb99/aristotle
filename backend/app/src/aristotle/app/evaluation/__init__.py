...
- :mod:`~aristotle.app.evaluation.runs` rebuilds a run from the transcript,
- :mod:`~aristotle.app.evaluation.checks` judges runs and knows nothing about SQL,
- :mod:`~aristotle.app.evaluation.fixtures` produces runs to judge.
...
``aristotle-admin eval``, which reads whatever a deployment actually did.
