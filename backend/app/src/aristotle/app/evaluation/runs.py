...
everything one turn wrote, which since aristotle's ADR 0018 is everything sharing
...
Kept apart from :mod:`aristotle.app.evaluation.checks` on purpose. Loading is the
