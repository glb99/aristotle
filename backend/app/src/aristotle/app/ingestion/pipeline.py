...
:class:`~aristotle.app.core.adapters.FunctionalProcessor` and hosted by a
:class:`~aristotle.app.core.handlers.StepHandler`. None of them import each other or
...
from aristotle.app.core.handlers import Handler, StepHandler
