...
from aristotle.app.architecture.views import router as architecture_router
from aristotle.app.auth.views import router as auth_router
from aristotle.app.ingestion.views import router as ingestion_router
from aristotle.app.ontologies.views import router as ontologies_router
from aristotle.app.personal.views import router as chat_router
...
def create_app(lifespan=None, console_dir: Path | None = None) -> FastAPI:
    ...
    """
    app = FastAPI(title="aristotle", lifespan=lifespan)
