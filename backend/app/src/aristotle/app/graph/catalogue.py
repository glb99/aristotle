...
:mod:`aristotle.app.architecture.catalogue` reached in for :class:`Relation` and
...
:mod:`aristotle.app.personal.catalogue`, where the domain that means them can be
...
:class:`~aristotle.app.graph.repository.SqlGraphRepository`, the same way the
