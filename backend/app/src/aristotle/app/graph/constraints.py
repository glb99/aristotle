...
:func:`~aristotle.app.graph.temporal.overlaps` can answer "cannot be determined",
...
from aristotle.app.graph.temporal import overlaps
...
accounts for it — see :mod:`aristotle.app.graph.inference`.
...
def conflicts_for(
    ...
    *,
    ...
    A free function over a :class:`~aristotle.app.graph.catalogue.Relation` rather
    ...
    :func:`~aristotle.app.graph.log.state_at`. Doing the narrowing here would hide
