...
:class:`~aristotle.app.sessions.models.ChatMemoryProposal`, which
...
from aristotle.app.sessions.models import ChatMemoryExtraction, ChatTranscriptItem
from aristotle.app.sessions.repository import KnownKeys
...
def _clean(item: Any) -> dict[str, str] | None:
    ...
    argument :class:`~aristotle.agent.session.store.MemoryEntry` makes for
