...
The second implementation of :class:`~aristotle.app.sessions.memory.MemoryStore`, and
...
:func:`~aristotle.app.graph.service.preferences_for`, which is the only thing in
the system that reads assertions on behalf of a prompt, and
:func:`~aristotle.app.graph.service.proposals_from` is deliberately a separate
