...
upstream. See aristotle's ADR 0017.
...
from aristotle.agent.runtime.runtime import RunResult, Runtime
from aristotle.agent.session.protocol import SessionRepository
from aristotle.agent.tools.memory import build_remember_tool
from aristotle.agent.tools.registry import ToolRegistry
from aristotle.app.core import observability
from aristotle.app.core.jobs import get_app
from aristotle.app.core.model_client import build_model_client
from aristotle.app.core.settings import get_settings
from aristotle.app.personal.tasks import extract_assertions_task, extract_memories_task
from aristotle.app.sessions.repository import KnownKeys, SqlSessionRepository
...
async def run_turn(
    ...
    Args:
        ...
        extract: Whether to queue memory extraction over what this turn wrote.
            ...
            :mod:`aristotle.app.ingestion.tasks` avoids by having the deferred
