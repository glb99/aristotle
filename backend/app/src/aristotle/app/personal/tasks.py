...
A thin shell, matching :mod:`aristotle.app.ingestion.tasks`: it opens a session,
builds a client, and calls :func:`aristotle.app.personal.memory_extraction.extract_memories`.
...
from aristotle.app.personal.claim_extraction import extract_assertions
from aristotle.app.personal.memory_extraction import extract_memories
