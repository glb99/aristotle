...
life's, and :mod:`aristotle.app.graph.catalogue` holds the shape a vocabulary has
...
from aristotle.app.graph.catalogue import Alias, Relation, Vocabulary
...
:func:`~aristotle.app.graph.service.confirm`, which redraws the node, and anything
...
Handed to :class:`~aristotle.app.graph.repository.SqlGraphRepository` at
