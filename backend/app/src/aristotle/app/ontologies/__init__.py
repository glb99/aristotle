...
:mod:`aristotle.app.entrypoints` plays for processes. It imports both domains;
...
Not :mod:`aristotle.app.core`, where ``_core_names_a_domain_concept`` would fire
and be right -- a registry naming domains is domain concepts. Not
:mod:`aristotle.app.graph`, which is substrate and imports no domain.
