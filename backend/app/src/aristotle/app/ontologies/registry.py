...
from aristotle.app.architecture.catalogue import CATALOGUE as ARCHITECTURE_RELATIONS
from aristotle.app.graph.catalogue import Vocabulary
from aristotle.app.personal.catalogue import VOCABULARY as PERSONAL_VOCABULARY
