...
This is also the only place an event loop is started. `aristotle` deliberately
...
`aristotle.agent.interfaces` composes the agent for running standalone, and this
