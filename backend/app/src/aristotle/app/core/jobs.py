...
``aristotle.agent.tools.approval``.
...
def _pool_factory(**kwargs: Any) -> psycopg_pool.AsyncConnectionPool:
    ...
    The indirection exists to keep a promise :mod:`aristotle.app.core.settings`
...
def get_app() -> App:
    ...
    :func:`aristotle.app.core.observability.configure` -- which is why declaring
    ...
    return App(
        ...
        # of those -- `aristotle-worker` and the in-API lifespan -- and they must
...
def register_tasks() -> App:
    ...
    """
    from aristotle.app.ingestion import tasks as _ingestion_tasks  # noqa: F401
    from aristotle.app.personal import tasks as _personal_tasks  # noqa: F401
