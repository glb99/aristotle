...
Separate from :mod:`aristotle.app.auth`, and deliberately. That package answers "who
...
from aristotle.agent.session.store import SessionState, UnknownSessionError
