...
:class:`~aristotle.app.architecture.conversation.OnlyReads` — an allowlist of
...
Not built:
    ...
    the person clicks. See aristotle's ADR 0017 and ``chat/service.py``.
"""
...
from aristotle.agent.tools.registry import ToolDefinition
from aristotle.app.architecture.classify import sentence
from aristotle.app.architecture.service import Model
    ...
    return ToolDefinition(
        ...
        input_schema={
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "description": "Dotted package name, e.g. aristotle.app.graph",
                }
            },
            "required": ["name"],
        },
