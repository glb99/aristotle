...
Everything in :mod:`~aristotle.app.architecture.derive` is read off the grammar
...
from aristotle.app.architecture.catalogue import IMPORTS, OWNS_TABLE
from aristotle.app.architecture.derive import Derived, Import

AGENT = "aristotle.agent"
APP = "aristotle.app"
CORE = "aristotle.app.core"
INTERFACES = "aristotle.agent.interfaces"
...
BOUNDARIES: tuple[Boundary, ...] = (
    ...
    Boundary(
        ...
        sentence="The application never imports aristotle.agent.interfaces.",
